...
class LiveEEGFilter:
    ...
    def get_power_in_band(self, band='beta', window_seconds=1):
...
class EEGRecorderWithFilter:
    def __init__(self):
        ...
        self.plot_window_size = 3  # Reduced from 10 to 3 seconds for better excited state detection
        self.fig = None
        self.axes = None
        self.lines = {}
        self.ani = None
    ...
    def add_to_filtered_plot_buffer(self, raw_data, filtered_data, timestamp):
        ...
        # Keep only recent data (last window_size + 2 seconds) - reduced for better responsiveness
        current_time = time.time() - self.start_time
        cutoff_time = current_time - self.plot_window_size - 2
